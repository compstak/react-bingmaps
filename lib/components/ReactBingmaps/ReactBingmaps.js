  ...
  _createClass(ReactBingmaps, [
    ...
    },
    {
      ...
      value: function componentWillReceiveProps(nextProps) {
        ...
        if (
          this.props.panoramaLookupRadius !== nextProps.panoramaLookupRadius
        ) {
          this.setPanoramaLookupRadius(panoramaLookupRadius, mapReference);
        }
        if (this.props.pitch !== nextProps.pitch) {
          this.setPitch(pitch, mapReference);
        }
        if (this.props.locationToLookAt !== nextProps.locationToLookAt) {
          this.setLocationToLookAt(locationToLookAt, mapReference);
        }
      },
    },
    {
      ...
      value: function reactBingmaps(props, Microsoft) {
        var bingmapKey = props.bingmapKey,
          ...
          panoramaLookupRadius = props.panoramaLookupRadius,
          pitch = props.pitch,
          locationToLookAt = props.locationToLookAt;
    ...
    {
      key: "setPanoramaLookupRadius",
      value: function setPanoramaLookupRadius(
        panoramaLookupRadius,
        mapReference
      ) {
        console.log("panoramaLookupRadius", panoramaLookupRadius);
        if (map[mapReference] && panoramaLookupRadius) {
          map[mapReference].setView({ panoramaLookupRadius });
        }
      },
    },
    ...
    {
      key: "setLocationToLookAt",
      value: function setLocationToLookAt(locationToLookAt, mapReference) {
        console.log("locationToLookAt", locationToLookAt);
        if (map[mapReference] && locationToLookAt) {
          map[mapReference].setView({ locationToLookAt });
        }
      },
    },
