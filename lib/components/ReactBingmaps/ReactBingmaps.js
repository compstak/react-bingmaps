  ...
  _createClass(ReactBingmaps, [
    ...
    },
    {
      ...
      value: function componentWillReceiveProps(nextProps) {
        ...
        if (map[mapReference]) {
          window.__map__ = map[mapReference];
        }
        ...
        if (
          this.props.mapTypeId !== nextProps.mapTypeId ||
        ...
        if (this.props.pitch !== nextProps.pitch) {
          this.setPitch(pitch, mapReference);
        }
        if (this.props.heading !== nextProps.heading) {
          this.setHeading(heading, mapReference);
        }
        if (this.props.streetsideOptions !== nextProps.streetsideOptions) {
          this.setStreetsideOptions(streetsideOptions, mapReference);
        }
      },
    },
    {
      ...
      value: function reactBingmaps(props, Microsoft) {
        var bingmapKey = props.bingmapKey,
          ...
          pitch = props.pitch,
          streetsideOptions = props.streetsideOptions;
    ...
    {
      key: "setPitch",
      value: function setPitch(pitch, mapReference) {
        if (map[mapReference] && pitch) {
          map[mapReference].setView({ pitch });
        }
      },
    },
    ...
    {
      key: "setHeading",
      value: function setHeading(heading, mapReference) {
        if (map[mapReference] && heading) {
          map[mapReference].setView({ heading });
        }
      },
    },

    {
      key: "setStreetsideOptions",
      value: function setStreetsideOptions(streetsideOptions, mapReference) {
        console.log(111111, streetsideOptions);
        if (map[mapReference] && streetsideOptions) {
          map[mapReference].setView({ streetsideOptions });
        }
      },
    },
...
ReactBingmaps.propTypes = {
  ...
  streetsideOptions: _propTypes2.default.shape({
    locationTooLookAt: _propTypes2.default.arrayOf(_propTypes2.default.number),
    disablePanoramaNavigation: _propTypes2.default.boolean,

    locationToLookAt: _propTypes2.default.arrayOf(_propTypes2.default.number),

    onErrorLoading: _propTypes2.default.object,

    onSuccessLoading: _propTypes2.default.object,

    overviewMapMode: _propTypes2.default.string,

    panoramaInfo: _propTypes2.default.shape({ cd: _propTypes2.default.string }),

    panoramaLookupRadius: _propTypes2.default.number,

    showCurrentAddress: _propTypes2.default.boolean,

    showExitButton: _propTypes2.default.boolean,

    showHeadingCompass: _propTypes2.default.boolean,

    showProblemReporting: _propTypes2.default.boolean,

    showZoomButtons: _propTypes2.default.boolean,
  }),
};
